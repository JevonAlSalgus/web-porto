...
const Header = () => {
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Gunakan if(header) sebagai pengaman agar tidak error jika header null
      if (header) {
    ...
    // Nyalakan event listener saat komponen dipasang
    window.addEventListener("scroll", handleScroll);

    // Matikan event listener saat pindah halaman (Cleanup)
    return () => {
      window.removeEventListener("scroll", handleScroll);
    };
  }, []); // Array kosong [] artinya efek ini hanya dijalankan sekali saat mount
          ...
          <ul className="nav_list grid">
            ...
            <li className="nav_item">
              <a
                ...
                className={
                  activeNav === "#qualification" ? "nav_link active-link" : "nav_link"
                }
              >
